...
def signup():
    ...
    bgImage1 = ImageTk.PhotoImage(file='bg.jpg')
    bgLabel = Label(signup_screen, image=bgImage1)
    bgLabel.place(x=0, y=0)

    heading = Label(signup_screen, text="CREATE ACCOUNT", font=("Microsoft Yahei UI Light", 16, 'bold'), bg='white', fg='firebrick1')
    heading.place(x=575, y=120)

    global username_entry
    username_entry = Entry(signup_screen, width=20, font=("Microsoft Yahei UI Light", 12, 'bold'), bd=0, fg='firebrick1')
    username_entry.place(x=575, y=200)
    username_entry.insert(0, 'Username')
    username_entry.bind('<FocusIn>', user_enter)

    frame1 = Frame(signup_screen, width=250, height=2, bg='firebrick1')
    frame1.place(x=575, y=230)

    global password_entry
    password_entry = Entry(signup_screen, width=20, font=("Microsoft Yahei UI Light", 12, 'bold'), bd=0, fg='firebrick1')
    password_entry.place(x=575, y=270)
    password_entry.insert(0, 'Password')
    password_entry.bind('<FocusIn>', pass_enter)

    frame2 = Frame(signup_screen, width=250, height=2, bg='firebrick1')
    frame2.place(x=575, y=300)

    create_acc_button = Button(signup_screen, text="Create account", width=17, font=('Open Sans', 14, 'bold'), fg='white', bg='firebrick1', activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, command=connect_database)
    create_acc_button.place(x=575, y=340)

    or_label = Label(signup_screen, text='------------ OR ------------', font=('Open Sans', 14), fg="firebrick1", bg='white')
    or_label.place(x=575, y=400)

    login_label = Label(signup_screen, text="Already have an account?", font=('Open Sans', 10, 'bold'), fg="firebrick1", bg='white')
    login_label.place(x=600, y=450)

    already_acc_button = Button(signup_screen, text="Login here", font=('Open Sans', 10, 'bold underline'), fg='blue', bg='white', activeforeground='white', activebackground='white', cursor='hand2', bd=0, command=login_page)
    already_acc_button.place(x=640, y=480)
...
def login():
    ...
    bgLabel = Label(login_screen, image=bgImage)
    bgLabel.place(x=0, y=0)

    heading = Label(login_screen, text="USER LOGIN", font=("Microsoft Yahei UI Light", 20, 'bold'), bg='white', fg='firebrick1')
    heading.place(x=595, y=120)

    global username_entry
    username_entry = Entry(login_screen, width=20, font=("Microsoft Yahei UI Light", 12, 'bold'), bd=0, fg='firebrick1')
    username_entry.place(x=575, y=200)
    username_entry.insert(0, 'Username')
    username_entry.bind('<FocusIn>', user_enter)

    frame1 = Frame(login_screen, width=250, height=2, bg='firebrick1')
    frame1.place(x=575, y=230)

    global password_entry
    password_entry = Entry(login_screen, width=20, font=("Microsoft Yahei UI Light", 12, 'bold'), bd=0, fg='firebrick1')
    password_entry.place(x=575, y=270)
    password_entry.insert(0, 'Password')
    password_entry.bind('<FocusIn>', pass_enter)

    frame2 = Frame(login_screen, width=250, height=2, bg='firebrick1')
    frame2.place(x=575, y=300)

    login_button = Button(login_screen, text="Login", width=17, font=('Open Sans', 14, 'bold'), fg='white', bg='firebrick1', activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, command=login_user)
    login_button.place(x=575, y=340)

    or_label = Label(login_screen, text='------------ OR ------------', font=('Open Sans', 14), fg="firebrick1", bg='white')
    or_label.place(x=575, y=400)

    signup_label = Label(login_screen, text="Don't have an account?", font=('Open Sans', 10, 'bold'), fg="firebrick1", bg='white')
    signup_label.place(x=600, y=450)

    new_acc_button = Button(login_screen, text="Create new one", font=('Open Sans', 10, 'bold underline'), fg='blue', bg='white', activeforeground='white', activebackground='white', cursor='hand2', bd=0, command=signup_page)
    new_acc_button.place(x=630, y=480)
